...
def log_tool_execution(tool_name: str, result: dict):
    ...
    if tool_name == "read_file":
        ...
        console.print(Text("✓ ", style="green bold") + Text(f"ReadFile {file_path} → {summary}", style="white"))
        ...
        console.print(Text("✓ ", style="green bold") + Text(f"SearchText '{query}' in {file_path} → {summary}", style="white"))
        ...
        console.print(Text(f"{icon} ", style=color) + Text(f"Edit {os.path.basename(file_path)} → {status}", style="white"))
        ...
        console.print(Text(f"{icon} ", style=color) + Text(f"Shell {working_dir} $ {command} → {status}", style="white"))
