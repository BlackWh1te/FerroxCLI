...
async def x_login_via_browser(timeout_seconds: int = 180) -> str:
    ...
    the redirect to x.com/home, capture cookies, and persist them.
    """
    try:
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            print("\n" + "=" * 60)
            print("  🐦  X Browser Login (Stealth Mode)")
            print("=" * 60)
            print("  A Chromium window has opened.")
            print("  It looks like a normal Chrome browser to X.")
            ...
            # Detect successful login: wait for home timeline URL.
